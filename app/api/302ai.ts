...
async function request(req: NextRequest) {
  ...
  // Use server config API key if available, otherwise fallback to client authorization
  const authorizationHeader = serverConfig.ai302ApiKey
    ? `Bearer ${serverConfig.ai302ApiKey}`
